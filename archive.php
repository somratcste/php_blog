...
/* ===================== Pagination Code Starts ================== */
			...
			$statement = $db->prepare("SELECT * FROM tbl_posts WHERE year=? AND month=? ORDER BY post_id DESC");
			...
			$statement = $db->prepare("SELECT * FROM tbl_posts WHERE year=? AND month=? ORDER BY post_id DESC LIMIT $start, $limit");
			$statement->execute(array($year1,$month1));

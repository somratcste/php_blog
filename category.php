...
/* ===================== Pagination Code Starts ================== */
			...
			$statement = $db->prepare("SELECT * FROM tbl_posts WHERE cat_id = ? ORDER BY post_id DESC");
			...
			$statement = $db->prepare("SELECT * FROM tbl_posts WHERE cat_id = ? ORDER BY post_id DESC LIMIT $start, $limit");
			$statement->execute(array($id));

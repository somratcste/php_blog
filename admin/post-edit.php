...
if(isset($_POST['form1'])) {
	...
	try {
		...
		if(empty($_FILES["post_image"]["name"])) {
			...
			$statement = $db->prepare("UPDATE tbl_posts SET post_title=?, post_description=?, cat_id=?, tag_id=? WHERE post_id=?");
			...
			$statement = $db->prepare("UPDATE tbl_posts SET post_title=?, post_description=?,post_image=?, cat_id=?, tag_id=? WHERE post_id=?");
...
?>
			...
			<!--<input type="hidden" name="id" value="<?php echo $id; ?>">-->
				<table class="tbl1">
				    ...
				    <tr><td><img src="../uploads/<?php echo $post_image; ?>" alt="" width="200" alt=""></td></tr>
				    <tr><td>Add Featured Image</td></tr>
